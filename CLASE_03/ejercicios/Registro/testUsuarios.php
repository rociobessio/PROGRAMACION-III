<?php
    ...
    $listaUsuarios = array(new Usuario("Rocio",123,"rocibessio@gmail.com"),
                           new Usuario("Claudia",12233,"cv2320@gmail.com"),
    ...
    $usuario_Clave_Incorrecta = new Usuario("",1231231,"rocibessio@gmail.com");//-->Deberia de lanzar error de verificación
