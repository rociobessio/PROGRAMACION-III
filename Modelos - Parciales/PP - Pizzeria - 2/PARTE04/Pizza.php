...
//********************************************* FUNCIONES *********************************************
       ...
       public static function CargarProducto($pizzaExistente,$pizzas,$precio,$cantidad,$jsonFile,$tipo,$sabor,$imagen=null,$directorioImagen=null){
        ...
        if($pizzaExistente !== null){//-->Quiere decir que existe
            ...
            if(move_uploaded_file($imagen['tmp_name'],$rutaImg)){
                $nuevaPizza->setImagen($rutaImg);//-->Asigno la imagen 
            }
        ...
        * 
        * @return bool true si pudo actualizar en el JSON,
        * false sino pudo.
        */
       public static function ActualizarProducto(&$productos, $productoExistente, $jsonFilename)
        { 
            foreach ($productos as &$producto) {
            ...
            return Pizza::GuardarJSON($productos,$jsonFilename) ? true : false;
        }
