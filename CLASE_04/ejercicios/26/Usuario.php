...
//----------------------------- Constructor -----------------------------  
         ...
         */
        public function __construct($clave,$mail,$nombre = null,$urlImg = null,$_fechaRegistro = null,$id = null)
        {
            if($nombre !== null && $urlImg !== null){
                ...
                //-->Al traerme los usuarios les volvia a asignar un id distinto y nunca los encontraba
                if( $id !== null){
                    $this->_id = $id;
                }
                else
...
//----------------------------- Funciones -----------------------------  
        ...
        /**
        * Funcion que busca a un usuario mediante su id
        * dentro del archivo json y lo retorna.
        * En caso de no existir retorna null.
        */
        public static function BuscarUsuario($idUsuario)
        {
            $usuarios = Usuario::ObtenerUsuarios("usuarios.json");
            $idUsuario = intval($idUsuario); //-->Convierto ID a INT
