<?php
    ...
    require_once "./32/classes/usuario.php";
    ...
    class UsuarioController{
        ...
        public function modificarUsuario($email,$claveNueva,$claveVieja){
            return Usuario::modificarUsuario($email,$claveNueva,$claveVieja);
        }
    }